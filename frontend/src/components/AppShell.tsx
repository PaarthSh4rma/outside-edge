  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto min-h-screen w-full max-w-7xl px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
        <header className="sticky top-3 z-50 mb-6 sm:top-4">
          <div
            className={
              themeMode === "dark"
                ? "border border-white/10 bg-[#101513]/95 px-4 py-3 shadow-xl backdrop-blur"
                : "border border-black/10 bg-white/95 px-4 py-3 shadow-sm backdrop-blur"
            }
          >
            ...
            <nav
              className="mt-3 grid grid-cols-3 border-t border-current/10 pt-3 sm:hidden"
              aria-label="Primary"
            >
              <NavItem to="/" label="Home" />
              <NavItem to="/matches" label="Matches" />
              <NavItem to="/daily-yorker" label="Yorker" />
            </nav>
          </div>
        </header>
        ...
        >
          <div className="flex flex-wrap justify-between gap-3">
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/matches" className="font-bold hover:underline">
                Match centre
              </Link>
